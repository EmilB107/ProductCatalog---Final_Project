            ...
            <form>
                <div class="mb-4">
                    <input type="text" class="form-control fw-bold mb-4"
                        ...
                        id="name" name="name" placeholder="Project Manager Name">
                    ...
                    <div id="permissions-list" class="d-flex flex-wrap gap-2">
                        <span class="badge rounded-pill px-4 py-2"
                            style="background:#f7bcbc; color:#222; font-weight:500;">View Projects</span>
                        <span class="badge rounded-pill px-4 py-2"
                            style="background:#f7bcbc; color:#222; font-weight:500;">Edit Projects</span>
                        <span class="badge rounded-pill px-4 py-2"
