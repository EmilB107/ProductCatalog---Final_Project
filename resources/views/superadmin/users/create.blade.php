...
@section('content')
            ...
            <form>
                <div class="mb-4">
                    <input type="text" class="form-control fw-bold mb-4"
                        ...
                        id="name" name="name" placeholder="Name of Employee">
                    ...
                    <div id="permissions-list" class="d-flex flex-wrap gap-2">
                        ...
                        <span class="badge rounded-pill px-4 py-2"
                            style="background:#f7bcbc; color:#222; font-weight:500;">create-product</span>
                        <span class="badge rounded-pill px-4 py-2"
                            style="background:#f7bcbc; color:#222; font-weight:500;">edit-product</span>
                        <span class="badge rounded-pill px-4 py-2"
                            style="background:#f7bcbc; color:#222; font-weight:500;">delete-product</span>
                        <span class="badge rounded-pill px-4 py-2"
                            style="background:#f7bcbc; color:#222; font-weight:500;">view-users</span>
                        <span class="badge rounded-pill px-4 py-2"
                            style="background:#f7bcbc; color:#222; font-weight:500;">edit-users</span>
                        <span class="badge rounded-pill px-4 py-2"
    ...
    <script>
        ...
        const rolePermissions = {
            ...
            'Project Manager': ['create-product', 'edit-product', 'view-users', 'assign-tasks']
        };
